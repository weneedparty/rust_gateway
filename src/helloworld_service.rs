pub mod helloworld_service_implementation {
    ...
    // #[path = "../src/utils.rs"]
    // pub mod utils;
    use crate::utils::my_utils::get_timestamp; //we can use `crate::` to get main.rs imported module
    ...
    impl Greeter for MyGreeter {
        ...
        async fn get_current_users_uuid(
            ...
            let mut current_users = self.current_users.clone();
            filter_out_users_that_do_not_active_for_more_than_x_milliseconds(
                &mut current_users,
                1000,
            )
            .await;
